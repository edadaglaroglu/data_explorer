...
st.title("Data Explorer: Natural Language Data Exploration 🤖")
st.divider()
...
load_data_btn = st.sidebar.button(label="Load", on_click=activate_dataload, use_container_width=True)
...
if st.session_state.dataload:
    ...
    with col_prework:
        ...
        st.subheader("Sample Data from Your File:")
    ...
    with col_interaction:
        ...
        variable_of_interest = st.text_input(label="Which Variable Would You Like to Examine?")
